...
public class Database {
    ...
    public static void addNewRoom(String roomType, String roomNo){
        ...
        try{
            ...
            System.out.println("Database Connected");
            String query = "SELECT * FROM room2 WHERE RoomType= "+"'"+roomType+"'" ;
            ...
            ResultSet rs = st.executeQuery(query);
                ...
                Integer guest = rs.getInt("Guest");
                Integer Bed = rs.getInt("Bed");
                double pricePerN= rs.getDouble("Price/Night");


            String sql="insert into room2 values(?,?,?,?,?,?,?)" ;
            PreparedStatement stmt = conn.prepareStatement(sql);
